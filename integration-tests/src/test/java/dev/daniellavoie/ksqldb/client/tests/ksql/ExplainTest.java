...
public class ExplainTest extends EndpointTest {

	private String queryId;

	@BeforeEach
	public void setup() {
		queryId = getQueries().blockFirst().getId();
	}

	@Test
	public void assertExplainQuery() {
		List<ExplainResponse> responses = ksqlDBClient.explain(new KsqlRequest("EXPLAIN " + queryId + ";"))
				.collectList().block();
