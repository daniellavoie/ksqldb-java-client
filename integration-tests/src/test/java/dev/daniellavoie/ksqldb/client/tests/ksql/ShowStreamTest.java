...
public class ShowStreamTest extends EndpointTest {
	@Test
	public void assertShowStreams() {
		StreamsResponse response = ksqlDBClient.streams(new KsqlRequest("SHOW STREAMS;")).blockFirst();
