...
public class ShowPropertiesTest extends EndpointTest {
	@Test
	public void assertShowProperties() {
		PropertiesResponse response = ksqlDBClient.properties(new KsqlRequest("SHOW PROPERTIES;")).blockFirst();
